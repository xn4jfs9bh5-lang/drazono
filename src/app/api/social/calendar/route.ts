...
export async function POST() {
  ...
  try {
    ...
    const msg = await client.messages.create({
      ...
      messages: [{ role: 'user', content: `Planning social 7 jours DRAZONO. Véhicules chinois (BYD, Chery, Haval, MG) prix réalistes. Format JSON: {"days":[{"day":"Lundi","theme":"...","tiktok":{"script":"...","hook":"...","hashtags":"..."},"instagram":{"caption":"...","hashtags":"...","visual_suggestion":"..."},"facebook":{"text":"...","cta":"..."},"whatsapp_status":"..."}]}. 7 jours Lundi à Dimanche.` }],
    })

    const text = msg.content[0].type === 'text' ? msg.content[0].text : ''
    console.log('[calendar] len:', text.length, 'start:', text.substring(0, 80))
